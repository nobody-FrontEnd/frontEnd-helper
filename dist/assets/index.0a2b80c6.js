import{d as C,q as G,r as l,H as v,c as A,w as g,u as e,o as Y,j as n,a,cg as I,R as Q,t as E,co as w,cd as q,h as R,_ as P}from"./index.fa3829f9.js";import{M as L}from"./MultiLineResult.eeac4e9b.js";import{g as h,e as z,h as M,k as S}from"./openpgp.min.ac9ba9ff.js";const D={class:"sign"},F={class:"sign-message"},N={class:"sign-private-key"},k={class:"option"},B=C({__name:"index",setup(U){const{t}=G(),f=`-----BEGIN PGP PRIVATE KEY BLOCK-----
...
`,m="passphrase",K="A Free, Modern Toolbox, Built for Developers.",p=l(f),i=l(m),d=l(K),c=l("");v(()=>{r()});async function r(){const V=await h({privateKey:await z({armoredKey:p.value}),passphrase:i.value}),s=await M({text:d.value}),u=await S({message:s,signingKeys:V});c.value=u}return(V,s)=>{const u=R("a-input-password"),y=R("a-space");return Y(),A(e(q),{"max-width":1280},{one:g(()=>[n("div",D,[n("div",F,[a(e(I),{modelValue:d.value,"onUpdate:modelValue":s[0]||(s[0]=o=>d.value=o),title:e(t)("pgp.sign.title.message")},null,8,["modelValue","title"])]),n("div",N,[a(e(I),{modelValue:p.value,"onUpdate:modelValue":s[1]||(s[1]=o=>p.value=o),title:e(t)("pgp.sign.title.private")},null,8,["modelValue","title"])]),n("div",k,[a(y,null,{default:g(()=>[Q(E(e(t)("pgp.sign.title.passphrase"))+" ",1),a(u,{value:i.value,"onUpdate:value":s[2]||(s[2]=o=>i.value=o),type:"password",class:"passphrase-input"},null,8,["value"]),a(e(w),{type:"primary",onClick:r},{default:g(()=>[Q(E(e(t)("pgp.sign.button")),1)]),_:1})]),_:1})]),n("div",null,[a(e(L),{"result-desc":e(t)("pgp.sign.title.result"),result:c.value},null,8,["result-desc","result"])])])]),_:1})}}});const O=P(B,[["__scopeId","data-v-ac72c26a"]]);export{O as default};
