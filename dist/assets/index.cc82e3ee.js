import{d as B,q as N,r as t,H as U,c as P,w as C,u as e,o as b,j as n,a as o,cg as V,R as h,t as G,co as K,aQ as w,aR as I,e3 as Q,cd as L,_ as S}from"./index.fa3829f9.js";import{M as k}from"./MultiLineResult.eeac4e9b.js";import{J as D,u as F,A as q}from"./openpgp.min.ac9ba9ff.js";const J={class:"verify"},j={class:"verify-signed-message"},O={class:"verify-public-key"},R={class:"verify-button"},x=B({__name:"index",setup(H){const{t:s}=N(),E=`-----BEGIN PGP PUBLIC KEY BLOCK-----
...
=Avpk
-----END PGP MESSAGE-----
`,r=t(E),u=t(M),p=t(""),c=t(""),v=t("success"),m=t(!1);U(()=>{A()});function A(){f(r.value,u.value).then(i=>{m.value=!0,i===""?(v.value="error",c.value=s("pgp.verify.message.fail")):(v.value="success",c.value=s("pgp.verify.message.success")),p.value=i})}async function f(i,a){const l=await D({armoredKey:i}),g=await F({armoredMessage:a}),d=await q({message:g,verificationKeys:l}),{verified:y,keyID:X}=d.signatures[0];try{return await y,d.data}catch{return""}return""}return(i,a)=>(b(),P(e(L),{"max-width":1280},{one:C(()=>[n("div",J,[n("div",j,[o(e(V),{modelValue:u.value,"onUpdate:modelValue":a[0]||(a[0]=l=>u.value=l),title:e(s)("pgp.verify.title.message")},null,8,["modelValue","title"])]),n("div",O,[o(e(V),{modelValue:r.value,"onUpdate:modelValue":a[1]||(a[1]=l=>r.value=l),title:e(s)("pgp.verify.title.public")},null,8,["modelValue","title"])]),n("div",R,[o(e(K),{type:"primary",onClick:A},{default:C(()=>[h(G(e(s)("pgp.verify.button")),1)]),_:1})]),n("div",null,[w(o(e(Q),{message:c.value,type:v.value},null,8,["message","type"]),[[I,m.value]]),o(e(k),{"result-desc":e(s)("pgp.verify.title.result"),result:p.value},null,8,["result-desc","result"])])])]),_:1}))}});const W=S(x,[["__scopeId","data-v-4c0f837a"]]);export{W as default};
