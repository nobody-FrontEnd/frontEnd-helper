import{d as D,q as G,H as L,r as u,c as x,w as d,u as e,o as U,j as g,a as s,cg as m,R as A,t as w,co as Y,cd as f,h as P,_ as z}from"./index.fa3829f9.js";import{M as q}from"./MultiLineResult.eeac4e9b.js";import{g as V,e as I,_ as K,u as T}from"./openpgp.min.ac9ba9ff.js";const v={class:"decrypt"},b={class:"decrypt-button"},R=D({__name:"index",setup(C){const{t:n}=G(),M=`-----BEGIN PGP MESSAGE-----
...
`,S="passphrase";L(()=>{y()});const r=u(M),l=u(O),c=u(S),E=u("");function y(){Q(r.value,l.value,c.value).then(i=>{E.value=i})}async function Q(i,t,p){let o;try{return p!==""?o=await V({privateKey:await I({armoredKey:t}),passphrase:p}):o=await I({armoredKey:t}),(await K({message:await T({armoredMessage:i}),decryptionKeys:o})).data}catch{return"Decryption failed"}}return(i,t)=>{const p=P("a-input-password"),o=P("a-space");return U(),x(e(f),{"max-width":1280},{one:d(()=>[g("div",v,[g("div",null,[s(e(m),{modelValue:r.value,"onUpdate:modelValue":t[0]||(t[0]=a=>r.value=a),title:e(n)("pgp.decrypt.title.message"),class:"message-input"},null,8,["modelValue","title"]),s(e(m),{modelValue:l.value,"onUpdate:modelValue":t[1]||(t[1]=a=>l.value=a),title:e(n)("pgp.decrypt.title.private")},null,8,["modelValue","title"])]),g("p",b,[s(o,null,{default:d(()=>[A(w(e(n)("pgp.decrypt.title.passphrase"))+" ",1),s(p,{value:c.value,"onUpdate:value":t[2]||(t[2]=a=>c.value=a),type:"password",class:"passphrase-input"},null,8,["value"]),s(e(Y),{type:"primary",onClick:y},{default:d(()=>[A(w(e(n)("pgp.decrypt.button")),1)]),_:1})]),_:1})]),s(e(q),{"result-desc":e(n)("pgp.decrypt.title.result"),result:E.value},null,8,["result-desc","result"])])]),_:1})}}});const W=z(R,[["__scopeId","data-v-3d31302e"]]);export{W as default};
