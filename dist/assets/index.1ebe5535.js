import{d as f,q as A,r as c,M as E,an as v,c as P,w as p,u as e,o as g,j as x,a as o,cg as I,t as B,fi as N,R as m,cd as q,h as w,_ as k}from"./index.fa3829f9.js";import{M as K}from"./MultiLineResult.eeac4e9b.js";const T={class:"PrivateToPublic"},D=f({__name:"index",setup(U){const C=`-----BEGIN ENCRYPTED PRIVATE KEY-----
...
`,M="passphrase",{t:a}=A(),r=c(C),l=c(""),n=c(M);i();function i(){E.getRSAPublicKeyFromPrivateKey(r.value,n.value).then(t=>{l.value=t}).catch(t=>{v.error(t)})}return(t,s)=>{const d=w("a-button");return g(),P(e(q),{"max-width":1280},{one:p(()=>[x("div",T,[o(e(I),{modelValue:r.value,"onUpdate:modelValue":s[0]||(s[0]=u=>r.value=u),title:e(a)("rsaExtractor.private")},null,8,["modelValue","title"]),x("p",null,B(e(a)("rsaExtractor.passphrase")),1),o(e(N),{value:n.value,"onUpdate:value":s[1]||(s[1]=u=>n.value=u)},null,8,["value"]),o(d,{type:"primary",onClick:i},{default:p(()=>[m(B(e(a)("rsaExtractor.button")),1)]),_:1}),o(e(K),{result:l.value,"result-desc":e(a)("rsaExtractor.public")},null,8,["result","result-desc"])])]),_:1})}}});const b=k(D,[["__scopeId","data-v-c7a152c8"]]);export{b as default};
